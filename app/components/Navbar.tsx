  ...
  return (
    ...
    >
      <div className="flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          <svg className="w-6 h-6 fill-blue" viewBox="0 0 24 24">
            {isMenuOpen ? (
        ...
        <div className="hidden md:flex flex-1 justify-center space-x-8 text-base font-mono">
          <Link
            href="/pages/projects"
            className={`inline-flex items-center transition-all duration-150 hover:text-blue ${activePage(
              "/pages/projects"
            )}`}
          >
            PROJECTS
        ...
        <motion.div
          ...
          } md:hidden absolute top-20 left-0 right-0 bg-white flex-col items-center py-2 shadow-md space-y-3`}
        >
          <Link
            href="/pages/projects"
