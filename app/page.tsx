...
export default function Home() {
  return (
    <main className="overflow-hidden h-full w-full">
      <div className="flex flex-col mt-24 sm:mt-40 justify-center items-center text-center text-brown relative">
        <motion.div
          initial={{ opacity: 0, y: -100 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ type: "spring", stiffness: 100, damping: 25, delay: .3 }}
          className="text-9xl font-bold font-[fafo] text-red">
          MICHAEL
          < br />
          CHANG
        </motion.div>
        <motion.div
          ...
          className="w-52 sm:w-96 font-sans text-xl leading-6"
        >
          is a
          <span className="mx-3">
            <ChatBubble />
