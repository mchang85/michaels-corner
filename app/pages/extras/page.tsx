      ...
      <div className="container mx-auto p-4">
        ...
        >
          <button
            ...
            ${
              activeTab === "photo"
                ? "bg-blue text-white"
                : "text-black hover:bg-grey hover:text-white"
            }`}
          >
            photography 📷
          </button>
        ...
        {activeTab === "photo" && (
          <motion.section
            ...
            className="mb-12"
          >
            <h2 className="font-mono text-lg sm:text-xl mb-2 p-3">
              - fujifilm x-t30 II w/ 35mm f/2
            </h2>
        ...
        {activeTab === "music" && (
          <motion.section
            ...
            className="mb-12"
          >
            <h2 className="font-mono text-lg sm:text-xl mb-4 p-3">
              current rotation
            </h2>
            <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-center gap-4 p-4">
              <div>
                ...
                />
                <p className="text-left font-sans mt-2 text-sm">
                  delilah (pull me out of this)
                </p>
                <p className="text-left font-sans text-sm text-black">
                  fred again..
                </p>
              </div>
              <div>
